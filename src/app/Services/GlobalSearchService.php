...
class GlobalSearchService
{
    ...
    protected array $searchableEntities = [
        'clients' => [
            ...
            'route' => 'filament.funil.resources.clients.view',
            'displayField' => 'name',
        ...
        'processes' => [
            ...
            'route' => 'filament.funil.resources.processes.view',
            'displayField' => 'title',
        ...
        'proceedings' => [
            ...
            'route' => 'filament.funil.resources.proceedings.view',
            'displayField' => 'title',
            'subtitleField' => 'uid',
        ],
        'diligences' => [
            ...
            'route' => 'filament.funil.resources.diligences.view',
        ...
        'deadlines' => [
            ...
            'color' => 'red',
            'fields' => ['uid', 'title', 'description'],
            'route' => 'filament.funil.resources.deadlines.view',
            'displayField' => 'title',
            'subtitleField' => 'uid',
        ],
        'contracts' => [
            ...
            'route' => 'filament.funil.resources.contracts.view',
            'displayField' => 'title',
        ...
        'invoices' => [
            ...
            'route' => 'filament.funil.resources.invoices.view',
        ...
        'services' => [
            ...
            'route' => 'filament.funil.resources.services.view',
            'displayField' => 'description',
            'subtitleField' => 'uid',
        ],
        'time_entries' => [
            ...
            'route' => 'filament.funil.resources.time-entries.view',
            'displayField' => 'description',
            'subtitleField' => 'uid',
        ],
        'documents' => [
            ...
            'route' => 'filament.funil.resources.generated-documents.view',
            'displayField' => 'title',
            'subtitleField' => 'uid',
        ],
    ];
